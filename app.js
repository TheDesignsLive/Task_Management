...
// ✅ Mobile pings this when profile changes → broadcast to desktop clients
app.post('/api/notify-profile-update', (req, res) => {
    ...
    console.log('[Desktop] 👤 profile update broadcast triggered by mobile');
    return res.json({ success: true });
});
...
app.post('/api/notify-members-update', (req, res) => {
    ...
    console.log('[Desktop] 👥 members update broadcast triggered by mobile');
    return res.json({ success: true });
});
...
// ✅ Mobile pings when announcement added → broadcast to desktop clients
...
app.post('/api/notify-announcement-delete', (req, res) => {
    ...
    console.log('[Desktop] 🗑️ delete_announcement broadcast triggered by mobile, id:', id);
    return res.json({ success: true });
});
